...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # it seems like << is more versatile and you could chain several concatenations together.
    # += seems a bit confusing since it makes a new instance and will not update original copy
    # << also seems like it could use any kind of output like it does in C++ where you can << to stdout
  end
