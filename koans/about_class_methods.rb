...
class AboutClassMethods < EdgeCase::Koan
  ...
  def test_objects_have_methods  
    ...
    assert_equal 51, fido.methods.size
  end

  def test_classes_have_methods
    # puts Dog.methods.inspect
    assert_equal 90, Dog.methods.size
  end
  ...
  # Being new to Ruby I think the self.method is simpler to recognize and use
  
  # Are there times you might prefer one over the other?
  # I think class << self might be useful when you have multiple class methods to define at once.
