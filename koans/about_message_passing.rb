...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # I can't think of a use for the __send__ type,  I see __id__ also is in the list.
    # Makes me suspect that maybe you might need to override one and still have a send defined.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # It would no longer be a missing method.
  end
